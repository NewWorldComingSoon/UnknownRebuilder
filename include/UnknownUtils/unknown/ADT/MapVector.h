...
public:
    ...
    {
        static_assert(std::is_copy_constructible<ValueT>::value, "Cannot call lookup() if ValueT is not copyable.");
...
void
MapVector<KeyT, ValueT, MapType, VectorType>::remove_if(Function Pred)
{
    auto O = Vector.begin();
...
struct SmallMapVector
    : MapVector<KeyT, ValueT, SmallDenseMap<KeyT, unsigned, N>, SmallVector<std::pair<KeyT, ValueT>, N>>
{
};
