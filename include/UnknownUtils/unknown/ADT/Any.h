...
class Any
{
    ...
    struct StorageImpl : public StorageBase
    {
        ...
        std::unique_ptr<StorageBase> clone() const override { return unknown::make_unique<StorageImpl<T>>(Value); }
...
public:
    ...
    template <
        ...
        typename std::enable_if<
            unknown::conjunction<
                unknown::negation<std::is_same<typename std::decay<T>::type, Any>>,
                ...
                unknown::negation<std::is_convertible<Any, typename std::decay<T>::type>>,
                std::is_copy_constructible<typename std::decay<T>::type>>::value,
            int>::type = 0>
    Any(T &&Value)
    {
        using U = typename std::decay<T>::type;
        Storage = unknown::make_unique<StorageImpl<U>>(std::forward<T>(Value));
    }
