...
template <typename ResultT, typename Param0T, typename ArgT, ResultT (*Func)(Param0T, ArrayRef<const ArgT *>)>
struct VariadicFunction1
{
    ResultT operator()(Param0T P0) const { return Func(P0, None); }
...
{
    ResultT operator()(Param0T P0, Param1T P1) const { return Func(P0, P1, None); }

#define LLVM_DEFINE_OVERLOAD(N) \
    ResultT operator()(Param0T P0, Param1T P1, LLVM_COMMA_JOIN##N(const ArgT &A)) const \
    { \
        const ArgT *const Args[] = {LLVM_COMMA_JOIN##N(&A)}; \
...
{
    ResultT operator()(Param0T P0, Param1T P1, Param2T P2) const { return Func(P0, P1, P2, None); }

#define LLVM_DEFINE_OVERLOAD(N) \
    ResultT operator()(Param0T P0, Param1T P1, Param2T P2, LLVM_COMMA_JOIN##N(const ArgT &A)) const \
    { \
        const ArgT *const Args[] = {LLVM_COMMA_JOIN##N(&A)}; \
