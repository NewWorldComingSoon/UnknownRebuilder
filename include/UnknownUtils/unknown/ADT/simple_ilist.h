...
#include "unknown/ADT/ilist_base.h"
#include "unknown/ADT/ilist_iterator.h"
...
class simple_ilist : ilist_detail::compute_node_options<T, Options...>::type::list_base_type,
...
public:
    ...
    LLVM_NODISCARD size_type size() const { return std::distance(begin(), end()); }
    ...
    void splice(iterator I, simple_ilist &L2) { splice(I, L2, L2.begin(), L2.end()); }

    /// Splice in a node from another list.
    void splice(iterator I, simple_ilist &L2, iterator Node) { splice(I, L2, Node, std::next(Node)); }

    /// Splice in a range of nodes from another list.
    void splice(iterator I, simple_ilist &, iterator First, iterator Last)
    {
        list_base_type::transferBefore(*I.getNodePtr(), *First.getNodePtr(), *Last.getNodePtr());
    }
...
template <class Compare>
void
simple_ilist<T, Options...>::merge(simple_ilist &RHS, Compare comp)
{
...
template <class Compare>
void
simple_ilist<T, Options...>::sort(Compare comp)
{
    // Vacuously sorted.
