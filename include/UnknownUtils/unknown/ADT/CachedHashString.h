...
public:
    ...
    explicit CachedHashStringRef(StringRef S) : CachedHashStringRef(S, DenseMapInfo<StringRef>::getHashValue(S)) {}

    CachedHashStringRef(StringRef S, uint32_t Hash) : P(S.data()), Size(S.size()), Hash(Hash)
    {
...
{
    static CachedHashStringRef getEmptyKey() { return CachedHashStringRef(DenseMapInfo<StringRef>::getEmptyKey(), 0); }
    ...
    {
        return LHS.hash() == RHS.hash() && DenseMapInfo<StringRef>::isEqual(LHS.val(), RHS.val());
    }
};
...
class CachedHashString
{
    ...
    static char *getTombstoneKeyPtr() { return DenseMapInfo<char *>::getTombstoneKey(); }

    bool isEmptyOrTombstone() const { return P == getEmptyKeyPtr() || P == getTombstoneKeyPtr(); }

    struct ConstructEmptyOrTombstoneTy
    {
    };

    CachedHashString(ConstructEmptyOrTombstoneTy, char *EmptyOrTombstonePtr) : P(EmptyOrTombstonePtr), Size(0), Hash(0)
    {
...
public:
    ...
    explicit CachedHashString(StringRef S) : CachedHashString(S, DenseMapInfo<StringRef>::getHashValue(S)) {}

    CachedHashString(StringRef S, uint32_t Hash) : P(new char[S.size()]), Size(S.size()), Hash(Hash)
    {
    ...
    CachedHashString(const CachedHashString &Other) : Size(Other.Size), Hash(Other.Hash)
    {
    ...
    CachedHashString(CachedHashString &&Other) noexcept : P(Other.P), Size(Other.Size), Hash(Other.Hash)
    {
    ...
    operator CachedHashStringRef() const { return CachedHashStringRef(val(), Hash); }
...
struct DenseMapInfo<CachedHashString>
{
    ...
    {
        return CachedHashString(CachedHashString::ConstructEmptyOrTombstoneTy(), CachedHashString::getEmptyKeyPtr());
    }
    static CachedHashString getTombstoneKey()
    {
        return CachedHashString(
            CachedHashString::ConstructEmptyOrTombstoneTy(), CachedHashString::getTombstoneKeyPtr());
    }
