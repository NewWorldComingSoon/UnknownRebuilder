...
struct extract_sentinel_tracking<Option1, Options...> : extract_sentinel_tracking<Options...>
{
};
...
#endif
template <bool EnableSentinelTracking>
struct is_valid_option<ilist_sentinel_tracking<EnableSentinelTracking>> : std::true_type
{
};
...
struct check_options<Option1, Options...>
    : std::integral_constant<bool, is_valid_option<Option1>::value && check_options<Options...>::value>
{
};
...
{
    typedef node_options<
        T,
        extract_sentinel_tracking<Options...>::value,
