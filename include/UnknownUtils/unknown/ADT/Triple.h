...
public:
    ...
    {
        return Arch == Other.Arch && SubArch == Other.SubArch && Vendor == Other.Vendor && OS == Other.OS &&
    ...
    bool isGNUEnvironment() const
    {
        ...
        return Env == Triple::GNU || Env == Triple::GNUABIN32 || Env == Triple::GNUABI64 || Env == Triple::GNUEABI ||
    ...
    bool isWindowsMSVCEnvironment() const
    {
        return getOS() == Triple::Win32 &&
               (getEnvironment() == Triple::UnknownEnvironment || getEnvironment() == Triple::MSVC);
    }

    /// Checks if the environment is MSVC.
    bool isKnownWindowsMSVCEnvironment() const { return getOS() == Triple::Win32 && getEnvironment() == Triple::MSVC; }

    bool isWindowsCoreCLREnvironment() const { return getOS() == Triple::Win32 && getEnvironment() == Triple::CoreCLR; }

    bool isWindowsItaniumEnvironment() const { return getOS() == Triple::Win32 && getEnvironment() == Triple::Itanium; }

    bool isWindowsCygwinEnvironment() const { return getOS() == Triple::Win32 && getEnvironment() == Triple::Cygnus; }

    bool isWindowsGNUEnvironment() const { return getOS() == Triple::Win32 && getEnvironment() == Triple::GNU; }
    ...
    {
        return (getOS() == Triple::Linux || getOS() == Triple::KFreeBSD || getOS() == Triple::Hurd) && !isAndroid();
    }
    ...
    bool isPS4() const { return getVendor() == Triple::SCEI && getOS() == Triple::PS4; }
    ...
    bool isAArch64() const { return getArch() == Triple::aarch64 || getArch() == Triple::aarch64_be; }
    ...
    bool hasDefaultEmulatedTLS() const { return isAndroid() || isOSOpenBSD() || isWindowsCygwinEnvironment(); }
    ...
    unknown::Triple get32BitArchVariant() const;
    ...
    ///          architecture if no such variant can be found.
    unknown::Triple get64BitArchVariant() const;
    ...
    ///          architecture if no such variant can be found.
    unknown::Triple getBigEndianArchVariant() const;
    ...
    ///          architecture if no such variant can be found.
    unknown::Triple getLittleEndianArchVariant() const;
