...
public:
    ...
    template <typename U>
    /*implicit*/ ArrayRef(const SmallVectorTemplateCommon<T, U> &Vec) : Data(Vec.data()), Length(Vec.size())
    {
    }
...
template <typename T>
ArrayRef<T>
makeArrayRef(const T *data, size_t length)
{
...
template <typename T>
ArrayRef<T>
makeArrayRef(const T *begin, const T *end)
{
...
template <typename T>
ArrayRef<T>
makeArrayRef(const SmallVectorImpl<T> &Vec)
{
    return Vec;
}
...
ArrayRef<T>
makeArrayRef(const SmallVector<T, N> &Vec)
{
    return Vec;
}
...
template <typename T>
ArrayRef<T>
makeArrayRef(const ArrayRef<T> &Vec)
{
    return Vec;
}
...
template <typename T>
MutableArrayRef<T>
makeMutableArrayRef(T *data, size_t length)
{
...
template <typename T>
inline bool
operator==(ArrayRef<T> LHS, ArrayRef<T> RHS)
{
