...
class EquivalenceClasses
{
    ...
    public:
        ECValue(const ECValue &RHS) : Leader(this), Next((ECValue *)(intptr_t)1), Data(RHS.Data)
        {
...
public:
    ...
    member_iterator findLeader(const ElemTy &V) const { return findLeader(TheMapping.find(V)); }
    ...
    class member_iterator : public std::iterator<std::forward_iterator_tag, const ElemTy, ptrdiff_t>
    {
        friend class EquivalenceClasses;

        using super = std::iterator<std::forward_iterator_tag, const ElemTy, ptrdiff_t>;
    ...
    public:
        ...
        bool operator==(const member_iterator &RHS) const { return Node == RHS.Node; }
        bool operator!=(const member_iterator &RHS) const { return Node != RHS.Node; }
    };
};
