...
auto reverse(
    ...
    -> decltype(make_range(unknown::make_reverse_iterator(std::end(C)),
                           unknown::make_reverse_iterator(std::begin(C)))) {
  return make_range(unknown::make_reverse_iterator(std::end(C)),
                    unknown::make_reverse_iterator(std::begin(C)));
}
...
static auto deref_or_none(const Iter &I, const Iter &End)
    -> unknown::Optional<typename std::remove_const<
...
template <typename Iter> struct ZipLongestItemType {
  using type =
      unknown::Optional<typename std::remove_const<typename std::remove_reference<
