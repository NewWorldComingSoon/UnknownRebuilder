...
#include "unknown/Support/MachineValueType.h"
#include <cassert>
...
public:
    ...
    static LLT pointer(uint16_t AddressSpace, unsigned SizeInBits)
    {
        ...
        return LLT{/*isPointer=*/true, /*isVector=*/false, /*NumElements=*/0, SizeInBits, AddressSpace};
    }
    ...
    static LLT vector(uint16_t NumElements, unsigned ScalarSizeInBits)
    {
        ...
        return LLT{/*isPointer=*/false, /*isVector=*/true, NumElements, ScalarSizeInBits, /*AddressSpace=*/0};
    }
    ...
    explicit LLT(bool isPointer, bool isVector, uint16_t NumElements, unsigned SizeInBits, unsigned AddressSpace)
    {
    ...
    {
        return IsPointer == RHS.IsPointer && IsVector == RHS.IsVector && RHS.RawData == RawData;
    }
...
private:
    ...
    static const constexpr BitFieldInfo PointerAddressSpaceFieldInfo{
        23,
        PointerSizeFieldInfo[0] + PointerSizeFieldInfo[1]};
    ...
    static const constexpr BitFieldInfo VectorSizeFieldInfo{
        32,
        VectorElementsFieldInfo[0] + VectorElementsFieldInfo[1]};
    ...
    static const constexpr BitFieldInfo PointerVectorAddressSpaceFieldInfo{
        23,
        PointerVectorSizeFieldInfo[1] + PointerVectorSizeFieldInfo[0]};
    ...
    void init(bool IsPointer, bool IsVector, uint16_t NumElements, unsigned SizeInBits, unsigned AddressSpace)
    {
        ...
        else
        {
            ...
            if (!IsPointer)
                RawData =
                    maskAndShift(NumElements, VectorElementsFieldInfo) | maskAndShift(SizeInBits, VectorSizeFieldInfo);
            else
                RawData = maskAndShift(NumElements, PointerVectorElementsFieldInfo) |
    ...
    {
        return ((uint64_t)RawData) << 2 | ((uint64_t)IsPointer) << 1 | ((uint64_t)IsVector);
    }
};

inline raw_ostream &
operator<<(raw_ostream &OS, const LLT &Ty)
{
    Ty.print(OS);
    return OS;
}
