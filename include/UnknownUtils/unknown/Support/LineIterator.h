...
class line_iterator : public std::iterator<std::forward_iterator_tag, StringRef>
{
...
public:
    ...
    explicit line_iterator(const MemoryBuffer &Buffer, bool SkipBlanks = true, char CommentMarker = '\0');
    ...
    {
        return LHS.Buffer == RHS.Buffer && LHS.CurrentLine.begin() == RHS.CurrentLine.begin();
    }

    friend bool operator!=(const line_iterator &LHS, const line_iterator &RHS) { return !(LHS == RHS); }
