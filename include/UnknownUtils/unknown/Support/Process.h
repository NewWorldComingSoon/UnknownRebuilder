...
///
/// This file declares the unknown::sys::Process class which contains a collection
...
public:
    ...
    static void
    GetTimeUsage(TimePoint<> &elapsed, std::chrono::nanoseconds &user_time, std::chrono::nanoseconds &sys_time);
