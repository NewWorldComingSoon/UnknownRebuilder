    ...
    : public TrailingObjectsImpl<Align, BaseTy, TopTrailingObj, NextTy, MoreTys...>
{
    ...
    static constexpr bool requiresRealignment() { return RequiresRealignment::value; }
...
protected:
    ...
    static const NextTy *getTrailingObjectsImpl(const BaseTy *Obj, TrailingObjectsBase::OverloadToken<NextTy>)
    {
        ...
        if (requiresRealignment())
            return reinterpret_cast<const NextTy *>(unknown::alignAddr(Ptr, alignof(NextTy)));
        else
    ...
    static NextTy *getTrailingObjectsImpl(BaseTy *Obj, TrailingObjectsBase::OverloadToken<NextTy>)
    {
        ...
        if (requiresRealignment())
            return reinterpret_cast<NextTy *>(unknown::alignAddr(Ptr, alignof(NextTy)));
        else
        ...
        typename ExtractSecondType<MoreTys, size_t>::type... MoreCounts)
    {
        return ParentType::additionalSizeToAllocImpl(
            (requiresRealignment() ? unknown::alignTo<alignof(NextTy)>(SizeSoFar) : SizeSoFar) +
...
protected:
    ...
    static constexpr size_t additionalSizeToAllocImpl(size_t SizeSoFar) { return SizeSoFar; }
                            ...
                            TrailingTys...>
{
    ...
    static BaseTy *getTrailingObjectsImpl(BaseTy *Obj, TrailingObjectsBase::OverloadToken<BaseTy>) { return Obj; }
    ...
    static size_t callNumTrailingObjects(const BaseTy *Obj, TrailingObjectsBase::OverloadToken<BaseTy>) { return 1; }
...
public:
    ...
    template <typename... Tys>
    static constexpr typename std::enable_if<std::is_same<Foo<TrailingTys...>, Foo<Tys...>>::value, size_t>::type
    additionalSizeToAlloc(typename trailing_objects_internal::ExtractSecondType<TrailingTys, size_t>::type... Counts)
    {
    ...
    template <typename... Tys>
    static constexpr typename std::enable_if<std::is_same<Foo<TrailingTys...>, Foo<Tys...>>::value, size_t>::type
    totalSizeToAlloc(typename trailing_objects_internal::ExtractSecondType<TrailingTys, size_t>::type... Counts)
    {
    ...
    struct FixedSizeStorage
    {
        ...
        struct with_counts
        {
            ...
            typedef unknown::AlignedCharArray<alignof(BaseTy), Size> type;
        };
    };
