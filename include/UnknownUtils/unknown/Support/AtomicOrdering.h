...
inline bool
isValidAtomicOrderingCABI(Int I)
{
    return (Int)AtomicOrderingCABI::relaxed <= I && I <= (Int)AtomicOrderingCABI::seq_cst;
}
...
inline const char *
toIRString(AtomicOrdering ao)
{
    static const char *names[8] = {
        "not_atomic", "unordered", "monotonic", "consume", "acquire", "release", "acq_rel", "seq_cst"};
...
inline bool
isStrongerThan(AtomicOrdering ao, AtomicOrdering other)
{
...
inline bool
isAtLeastOrStrongerThan(AtomicOrdering ao, AtomicOrdering other)
{
    static const bool lookup[8][8] = {
        //               NA     UN     RX     CO     AC     RE     AR     SC
...
inline bool
isAcquireOrStronger(AtomicOrdering ao)
{
