...
void *operator new(size_t Size,
                   unknown::BumpPtrAllocatorImpl<AllocatorT, SlabSize,
  ...
  return Allocator.Allocate(
      Size, std::min((size_t)unknown::NextPowerOf2(Size), offsetof(S, x)));
}

template <typename AllocatorT, size_t SlabSize, size_t SizeThreshold>
void operator delete(
    void *, unknown::BumpPtrAllocatorImpl<AllocatorT, SlabSize, SizeThreshold> &) {
}
