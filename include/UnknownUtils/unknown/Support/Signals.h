...
/// signal delivery.
void
DontRemoveFileOnSignal(StringRef Filename);
...
void
PrintStackTraceOnErrorSignal(StringRef Argv0, bool DisableCrashReporting = false);
...
void
PrintStackTrace(raw_ostream &OS);
...
void
AddSignalHandler(SignalHandlerCallback FnPtr, void *Cookie);
