...
template <>
inline void
write<float>(raw_ostream &os, float value, endianness endian)
{
...
template <>
inline void
write<double>(raw_ostream &os, double value, endianness endian)
{
...
template <typename value_type>
inline void
write(raw_ostream &os, ArrayRef<value_type> vals, endianness endian)
{
