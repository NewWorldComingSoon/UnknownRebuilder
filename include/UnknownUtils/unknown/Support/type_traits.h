...
struct is_trivially_copy_constructible
    : std::is_copy_constructible<::unknown::detail::copy_construction_triviality_helper<T>>
{
};
template <typename T>
...
struct is_trivially_move_constructible
    : std::is_move_constructible<::unknown::detail::move_construction_triviality_helper<T>>
{
};
template <typename T>
