...
public:
    explicit FileCheckPattern(Check::FileCheckType Ty) : CheckTy(Ty) {}
...
private:
    ...
    unsigned ComputeMatchDistance(StringRef Buffer, const StringMap<StringRef> &VariableTable) const;
...
struct FileCheckString
{
    ...
    FileCheckString(const FileCheckPattern &P, StringRef S, SMLoc L) : Pat(P), Prefix(S), Loc(L) {}
