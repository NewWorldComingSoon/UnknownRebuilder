...
bool ConvertUTF8toWide(unsigned WideCharWidth, unknown::StringRef Source,
...
bool convertUTF16ToUTF8String(ArrayRef<char> SrcBytes, std::string &Out) {
  ...
  if (Src[0] == UNI_UTF16_BYTE_ORDER_MARK_SWAPPED) {
    ...
    for (unsigned I = 0, E = ByteSwapped.size(); I != E; ++I)
      ByteSwapped[I] = unknown::sys::SwapByteOrder_16(ByteSwapped[I]);
    Src = &ByteSwapped[0];
...
bool convertUTF16ToUTF8String(ArrayRef<UTF16> Src, std::string &Out)
{
  return convertUTF16ToUTF8String(
      unknown::ArrayRef<char>(reinterpret_cast<const char *>(Src.data()),
...
static inline bool ConvertUTF8toWideInternal(unknown::StringRef Source,
                                             TResult &Result) {
...
bool ConvertUTF8toWide(unknown::StringRef Source, std::wstring &Result) {
...
bool ConvertUTF8toWide(const char *Source, std::wstring &Result) {
  ...
  return ConvertUTF8toWide(unknown::StringRef(Source), Result);
}
...
bool convertWideToUTF8(const std::wstring &Source, std::string &Result) {
  if (sizeof(wchar_t) == 1) {
    ...
    return convertUTF16ToUTF8String(
        unknown::ArrayRef<UTF16>(reinterpret_cast<const UTF16 *>(Source.data()),
                              Source.size()),
        Result);
