...
#include "unknown/ADT/StringSwitch.h"
#include "unknown/Support/ErrorHandling.h"
#include "unknown/Support/Host.h"
#include "unknown/Support/TargetParser.h"
#include <cstring>
...
std::string Triple::normalize(StringRef Str) {
  ...
  if (Vendor == Triple::SUSE && Environment == unknown::Triple::GNUEABI)
...
static unsigned getArchPointerBitWidth(unknown::Triple::ArchType Arch) {
  switch (Arch) {
  case unknown::Triple::UnknownArch:
    return 0;

  case unknown::Triple::avr:
  case unknown::Triple::msp430:
    return 16;

  case unknown::Triple::arc:
  case unknown::Triple::arm:
  case unknown::Triple::armeb:
  case unknown::Triple::hexagon:
  case unknown::Triple::le32:
  case unknown::Triple::mips:
  case unknown::Triple::mipsel:
  case unknown::Triple::nvptx:
  case unknown::Triple::ppc:
  case unknown::Triple::r600:
  case unknown::Triple::riscv32:
  case unknown::Triple::sparc:
  case unknown::Triple::sparcel:
  case unknown::Triple::tce:
  case unknown::Triple::tcele:
  case unknown::Triple::thumb:
  case unknown::Triple::thumbeb:
  case unknown::Triple::x86:
  case unknown::Triple::xcore:
  case unknown::Triple::amdil:
  case unknown::Triple::hsail:
  case unknown::Triple::spir:
  case unknown::Triple::kalimba:
  case unknown::Triple::lanai:
  case unknown::Triple::shave:
  case unknown::Triple::wasm32:
  case unknown::Triple::renderscript32:
    return 32;

  case unknown::Triple::aarch64:
  case unknown::Triple::aarch64_be:
  case unknown::Triple::amdgcn:
  case unknown::Triple::bpfel:
  case unknown::Triple::bpfeb:
  case unknown::Triple::le64:
  case unknown::Triple::mips64:
  case unknown::Triple::mips64el:
  case unknown::Triple::nvptx64:
  case unknown::Triple::ppc64:
  case unknown::Triple::ppc64le:
  case unknown::Triple::riscv64:
  case unknown::Triple::sparcv9:
  case unknown::Triple::systemz:
  case unknown::Triple::x86_64:
  case unknown::Triple::amdil64:
  case unknown::Triple::hsail64:
  case unknown::Triple::spir64:
  case unknown::Triple::wasm64:
  case unknown::Triple::renderscript64:
    return 64;
  }
...
StringRef Triple::getARMCPUForArch(StringRef MArch) const {
  ...
  switch (getOS()) {
  case unknown::Triple::FreeBSD:
  case unknown::Triple::NetBSD:
    if (!MArch.empty() && MArch == "v6")
      return "arm1176jzf-s";
    break;
  case unknown::Triple::Win32:
    // FIXME: this is invalid for WindowsCE
    return "cortex-a9";
  case unknown::Triple::MacOSX:
  case unknown::Triple::IOS:
  case unknown::Triple::WatchOS:
  case unknown::Triple::TvOS:
    if (MArch == "v7k")
      return "cortex-a7";
    break;
  default:
  ...
  case unknown::Triple::NetBSD:
    ...
    case unknown::Triple::GNUEABIHF:
    case unknown::Triple::GNUEABI:
    case unknown::Triple::EABIHF:
    case unknown::Triple::EABI:
      return "arm926ej-s";
    default:
      return "strongarm";
    }
  case unknown::Triple::NaCl:
  case unknown::Triple::OpenBSD:
    return "cortex-a8";
  default:
    switch (getEnvironment()) {
    case unknown::Triple::EABIHF:
    case unknown::Triple::GNUEABIHF:
    case unknown::Triple::MuslEABIHF:
      return "arm1176jzf-s";
    default:
      return "arm7tdmi";
    }
