...
#include "unknown/Config/config.h" // Get build system configuration settings
...
unknown::VersionTuple
GetWindowsOSVersion();

bool
MakeErrMsg(std::string *ErrMsg, const std::string &prefix);
...
std::error_code
GetCommandLineArguments(SmallVectorImpl<const char *> &Args, BumpPtrAllocator &Alloc);
