...
enum class PDB_NO_DISCARD SymbolRecordKind : uint16_t
{
    ...
    S_OBJNAME = 0x1101u,  // full path to the original compiled .obj. can point to remote locations and temporary files,
                          // not necessarily the file that was linked into the executable
...
// internal Record structs such as S_PUB32, S_GDATA32, etc. correspond to the data layout of a CodeView record of that
// kind.
struct Record
{
    RecordHeader header;
