...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
PDB::SectionContributionStream::SectionContributionStream(void) PDB_NO_EXCEPT : m_stream(),
...
PDB::SectionContributionStream::SectionContributionStream(
    const DirectMSFStream &directStream,
    uint32_t size,
    uint32_t offset) PDB_NO_EXCEPT : m_stream(directStream, size, offset),
