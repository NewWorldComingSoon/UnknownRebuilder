...
public:
    ...
    inline constexpr explicit ArrayView(const T *const array, size_t length) PDB_NO_EXCEPT : m_data(array),
                                                                                             m_length(length)
    {
    }
    ...
    PDB_NO_DISCARD PDB_NO_ALIAS inline constexpr const T *Decay(void) const PDB_NO_EXCEPT { return m_data; }

    // Returns the length of the view.
    PDB_NO_DISCARD inline constexpr size_t GetLength(void) const PDB_NO_EXCEPT { return m_length; }
    ...
    PDB_NO_DISCARD PDB_NO_ALIAS inline const T *begin(void) const PDB_NO_EXCEPT { return m_data; }

    PDB_NO_DISCARD PDB_NO_ALIAS inline const T *end(void) const PDB_NO_EXCEPT { return m_data + m_length; }
