...
// ------------------------------------------------------------------------------------------------
// ------------------------------------------------------------------------------------------------
PDB::PublicSymbolStream::PublicSymbolStream(void) PDB_NO_EXCEPT : m_stream(), m_hashRecords(nullptr), m_count(0u) {}
...
PDB::PublicSymbolStream::GetRecord(const CoalescedMSFStream &symbolRecordStream, const HashRecord &hashRecord) const
    PDB_NO_EXCEPT
{
