...
BinaryStreamError::BinaryStreamError(stream_error_code C) : BinaryStreamError(C, "") {}

BinaryStreamError::BinaryStreamError(StringRef Context) : BinaryStreamError(stream_error_code::unspecified, Context) {}

BinaryStreamError::BinaryStreamError(stream_error_code C, StringRef Context) : Code(C)
{
    ErrMsg = "Stream Error: ";
    switch (C)
    {
...
void
BinaryStreamError::log(raw_ostream &OS) const
{
    OS << ErrMsg;
}

StringRef
BinaryStreamError::getErrorMessage() const
{
    return ErrMsg;
}
