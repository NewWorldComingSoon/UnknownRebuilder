...
static Optional<AlignStyle>
translateLocChar(char C)
{
    switch (C)
    {
    case '-':
...
bool
formatv_object_base::consumeFieldLayout(StringRef &Spec, AlignStyle &Where, size_t &Align, char &Pad)
{
...
formatv_object_base::splitLiteralAndReplacement(StringRef Fmt)
{
    ...
    while (From < Fmt.size() && From != StringRef::npos)
    {
        ...
        StringRef Braces = Fmt.drop_front(BO).take_while([](char C) { return C == '{'; });
