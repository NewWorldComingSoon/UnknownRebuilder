    ...
    bool *ExecutionFailed)
{
    ...
    if (Execute(PI, Program, Args, Env, Redirects, MemoryLimit, ErrMsg))
    {
        ...
        ProcessInfo Result = Wait(PI, SecondsToWait, /*WaitUntilTerminates=*/SecondsToWait == 0, ErrMsg);
...
bool
sys::commandLineFitsWithinSystemLimits(StringRef Program, ArrayRef<const char *> Args)
{
