...
#include "unknown/Support/CachePruning.h"
...
unknown::parseCachePruningPolicy(StringRef PolicyStr) {
...
bool unknown::pruneCache(StringRef Path, CachePruningPolicy Policy) {
