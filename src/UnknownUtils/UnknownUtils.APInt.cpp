...
hash_code unknown::hash_value(const APInt &Arg) {
  if (Arg.isSingleWord())
...
APInt unknown::APIntOps::GreatestCommonDivisor(APInt A, APInt B) {
...
APInt unknown::APIntOps::RoundDoubleToAPInt(double Double, unsigned width) {
...
APInt unknown::APIntOps::RoundingUDiv(const APInt &A, const APInt &B,
                                   APInt::Rounding RM) {
...
APInt unknown::APIntOps::RoundingSDiv(const APInt &A, const APInt &B,
                                   APInt::Rounding RM) {
  switch (RM) {
  case APInt::Rounding::DOWN:
  case APInt::Rounding::UP: {
...
Optional<APInt>
unknown::APIntOps::SolveQuadraticEquationWrap(APInt A, APInt B, APInt C,
                                           unsigned RangeWidth) {
