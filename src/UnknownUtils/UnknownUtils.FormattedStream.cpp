...
///
static void
UpdatePosition(std::pair<unsigned, unsigned> &Position, const char *Ptr, size_t Size)
{
...
/// counts.
void
formatted_raw_ostream::ComputePosition(const char *Ptr, size_t Size)
{
...
void
formatted_raw_ostream::write_impl(const char *Ptr, size_t Size)
{
    // Figure out what's in the buffer and add it to the column count.
