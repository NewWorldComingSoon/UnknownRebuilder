...
void
Twine::toVector(SmallVectorImpl<char> &Out) const
{
...
void
Twine::printOneChild(raw_ostream &OS, Child Ptr, NodeKind Kind) const
{
    switch (Kind)
    {
    case Twine::NullKind:
...
void
Twine::printOneChildRepr(raw_ostream &OS, Child Ptr, NodeKind Kind) const
{
    switch (Kind)
    {
    case Twine::NullKind:
...
void
Twine::print(raw_ostream &OS) const
{
...
void
Twine::printRepr(raw_ostream &OS) const
{
    OS << "(Twine ";
