...
#include "unknown/Support/AArch64TargetParser.h"
...
static unsigned
checkArchVersion(unknown::StringRef Arch)
{
...
unsigned
AArch64::getDefaultFPU(StringRef CPU, AArch64::ArchKind AK)
{
    if (CPU == "generic")
...
#include "unknown/Support/AArch64TargetParser.def"
        .Default(ARM::FK_INVALID);
}

unsigned
AArch64::getDefaultExtensions(StringRef CPU, AArch64::ArchKind AK)
{
    if (CPU == "generic")
...
#define AARCH64_CPU_NAME(NAME, ID, DEFAULT_FPU, IS_DEFAULT, DEFAULT_EXT) \
    .Case(NAME, AArch64ARCHNames[static_cast<unsigned>(ArchKind::ID)].ArchBaseExtensions | DEFAULT_EXT)
#include "unknown/Support/AArch64TargetParser.def"
...
bool
AArch64::getExtensionFeatures(unsigned Extensions, std::vector<StringRef> &Features)
{
...
bool
AArch64::getArchFeatures(AArch64::ArchKind AK, std::vector<StringRef> &Features)
{
...
unsigned
AArch64::getArchAttr(AArch64::ArchKind AK)
{
...
bool
AArch64::isX18ReservedByDefault(const Triple &TT)
{
    return TT.isAndroid() || TT.isOSDarwin() || TT.isOSFuchsia() || TT.isOSWindows();
}
