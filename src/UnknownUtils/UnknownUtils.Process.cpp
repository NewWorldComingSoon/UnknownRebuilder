...
Optional<std::string>
Process::FindInEnvPath(StringRef EnvName, StringRef FileName, ArrayRef<std::string> IgnoreList)
{
...
#define ALLCOLORS(FGBG, BOLD) \
    { \
        COLOR(FGBG, "0", BOLD), COLOR(FGBG, "1", BOLD), COLOR(FGBG, "2", BOLD), COLOR(FGBG, "3", BOLD), \
            COLOR(FGBG, "4", BOLD), COLOR(FGBG, "5", BOLD), COLOR(FGBG, "6", BOLD), COLOR(FGBG, "7", BOLD) \
    }
