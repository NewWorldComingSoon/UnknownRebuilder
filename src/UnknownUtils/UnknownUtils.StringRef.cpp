...
unsigned StringRef::edit_distance(unknown::StringRef Other,
...
bool unknown::consumeUnsignedInteger(StringRef &Str, unsigned Radix,
...
bool unknown::consumeSignedInteger(StringRef &Str, unsigned Radix,
                                long long &Result) {
...
bool unknown::getAsUnsignedInteger(StringRef Str, unsigned Radix,
                                unsigned long long &Result) {
...
bool unknown::getAsSignedInteger(StringRef Str, unsigned Radix,
                              long long &Result) {
...
hash_code unknown::hash_value(StringRef S) {
