...
BinaryStreamWriter::BinaryStreamWriter(WritableBinaryStreamRef Ref) : Stream(Ref) {}

BinaryStreamWriter::BinaryStreamWriter(WritableBinaryStream &Stream) : Stream(Stream) {}

BinaryStreamWriter::BinaryStreamWriter(MutableArrayRef<uint8_t> Data, unknown::support::endianness Endian) :
    Stream(Data, Endian)
{
}

Error
BinaryStreamWriter::writeBytes(ArrayRef<uint8_t> Buffer)
{
...
Error
BinaryStreamWriter::writeStreamRef(BinaryStreamRef Ref, uint32_t Length)
{
